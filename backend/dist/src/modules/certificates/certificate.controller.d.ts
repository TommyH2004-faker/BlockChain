...
export declare class CertificateController {
    ...
    constructor(certificateService: CertificateService, uploadService: UploadService);
    ...
    createCertificate(req: any, body: any, file: Express.Multer.File): Promise<Certificate>;
